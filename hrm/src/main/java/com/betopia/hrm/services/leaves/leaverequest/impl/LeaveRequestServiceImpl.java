...
import com.betopia.hrm.domain.leave.repository.LeaveRequestDocumentRepository;
...
public class LeaveRequestServiceImpl implements LeaveRequestService {
    ...
    public LeaveRequestServiceImpl(
            ...
            LeaveGroupAssignRepository leaveGroupAssignRepository, UploadFiles uploadFiles
    ) {
        ...
        this.leaveRequestDocumentRepository = leaveRequestDocumentRepository;
    ...
    @Override
    public PaginationResponse<LeaveRequest> index(Sort.Direction direction, int page, int perPage) {
        Pageable pageable = PageRequest.of(page - 1, perPage, Sort.by(direction, "id"));
        Page<LeaveRequest> leaveRequestPage = repository.findAll(pageable);
        List<LeaveRequest> leaveRequests = leaveRequestPage.getContent();

        PaginationResponse<LeaveRequest> response = new PaginationResponse<>();
