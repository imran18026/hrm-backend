...
public class ShiftServiceImpl implements ShiftService {
    ...
    public ShiftServiceImpl(ShiftRepository shiftRepository, ShiftCategoryRepository shiftCategoryRepository, CompanyRepository companyRepository, BusinessUnitRepository businessUnitRepository, WorkplaceGroupRepository workplaceGroupRepository, WorkplaceRepository workplaceRepository, DepartmentRepository departmentRepository, TeamRepository teamRepository, ShiftMapper shiftMapper) {
    ...
    public ShiftDTO store(ShiftRequest request) {
        ...
        shift.setBusinessUnit(businessUnitRepository.findById(request.businessUnitId())
                .orElseThrow(() -> new RuntimeException("Business unit not found")));

        shift.setWorkPlaceGroup(workplaceGroupRepository.findById(request.workPlaceGroupId())
                .orElseThrow(() -> new RuntimeException("Workplace group not found")));

        shift.setWorkPlace(workplaceRepository.findById(request.workPlaceId())
                .orElseThrow(() -> new RuntimeException("Workplace not found")));

        shift.setDepartment(departmentRepository.findById(request.departmentId())
                .orElseThrow(() -> new RuntimeException("Department not found")));

        shift.setTeam(teamRepository.findById(request.teamId())
