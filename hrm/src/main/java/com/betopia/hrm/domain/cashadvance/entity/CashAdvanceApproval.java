...
public class CashAdvanceApproval extends Auditable<Long,Long> {
    ...
    @JoinColumn(name = "advance_cash_request_id", nullable = false)
    ...
    @Column(name = "status")
    private CashAdvanceStatus cashAdvanceStatus;
    ...
    public CashAdvanceStatus getCashAdvanceStatus() {
        return cashAdvanceStatus;
    }

    public void setCashAdvanceStatus(CashAdvanceStatus cashAdvanceStatus) {
